...
| `--suggest-patches [FILE]` | - | Write mechanical fixes as a unified diff (default `portcullis.patch`). Review and `git apply` yourself - Portcullis never edits your files. |
